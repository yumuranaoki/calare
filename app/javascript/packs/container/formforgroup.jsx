...
import {handlePlus, handleCancel, handleSubmit, handleSecondCancel,
        handleSecondSubmit, handleChange} from '../action/formforgroup';
...
const mapDispatchToProps = dispatch => ({
  ...
  handleSecondSubmit: (starttime, endtime, timelength) => dispatch(handleSecondSubmit(starttime, endtime, timelength)),
